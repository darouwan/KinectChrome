...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        public GestureResultView(int bodyIndex, bool isTracked, bool detected, float confidence, string currentGesture)
        {
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence,string currentGesture)
        {
            ...
            else
            {
                ...
                if (this.Detected)
                {
                    ...
                    this.CurrentGesture = currentGesture;
                   //Console.WriteLine(isBodyTrackingIdValid + " " + isGestureDetected + " " + detectionConfidence + " " + currentGesture);
                }
                else
                {
